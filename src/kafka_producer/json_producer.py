...
FILE_PATH = "E:\DATA_PIPELINE\sample_data\kafka-sensor-topic\aps_failure_training_set1.csv"# "/home/avnish/iNeuron_Private_Intelligence_Limited/industry_ready_project/projects/data_pipeline/kafka-sensor/sample_data/sensor/aps_failure_training_set1.csv"
...
def product_data_using_file(topic,file_path):
    ...
    try:
        for instance in Generic.get_object(file_path=file_path):
            ...
            producer.produce(topic=topic,key=string_serializer(str(uuid4()), instance.to_dict()),
